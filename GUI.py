...
class Login:
   ...
   def __init__(self,root):
      ...
      self.root.geometry("1200x700+160+60")
   ...
   def loginform(self):
      ...
      Frame_login.place(x=0,y=0,height=600,width=1300)

      

      self.img=ImageTk.PhotoImage(file="assets/loginbg.jpg")

      img=Label(Frame_login,image=self.img).place(x=0,y=0,width=1200,height=700)
   ...
   def login(self):
      ...
      if self.email_txt.get()=="" or self.password.get()=="":
         ...
         try:
            ...
            con=pymysql.connect(host='localhost',user='root',password='2632',
   ...
   def Register(self):
      ...
      img=Label(Frame_login1,image=self.img).place(x=0,y=0,width=1200,height=700)
   ...
   def appscreen(self):
       ...
       call(["python", "spaceShooter.py"])

   def mama(self):
      import smtplib
      s = smtplib.SMTP('smtp.gmail.com', 587)
      s.starttls()
      s.login("socialise.with.socio@gmail.com", "2632kAr*&")
      message = "Welocme to Socio"
      s.sendmail("socialise.with.socio@gmail.com", "karthi2002m@gmail.com", message)
      s.quit()
